...
%         startA = 1;
%         endA = startA;
%         while (startA < length(labelFile.(behav)) && endA < length(labelFile.(behav)))
%             while(startA < length(labelFile.(behav)) && labelFile.(behav)(startA) ~= 1) % Go to start of behav
%                 startA = startA+1;
%             end;
%             endA = startA;
%             while (endA < length(labelFile.(behav)) && labelFile.(behav)(startA) == 1) % Go to end
%                 endA = endA+1;
%             end;
%             startMin;
